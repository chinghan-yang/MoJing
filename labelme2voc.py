...
def main():
    ...
    parser.add_argument("--input_file", help="Input annotated file")
    # parser.add_argument("output_dir", help="Output dataset directory")
    parser.add_argument(
        "--labels", help="Labels file or comma separated text", default="labels.txt"
    )
    parser.add_argument(
    ...
    if not args.nonpy:
        out_cls_file = osp.join(f"{base}.npy")
    # if not args.noviz:
    ...
    # if not args.noobject:
        ...
        # )
        # if not args.nonpy:
        #     out_ins_file = osp.join(f"{base}.npy")
        # if not args.noviz:
